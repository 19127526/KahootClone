...
const CardGroupComponent=({title,subTitle})=>{
  const navigate=useNavigate();

  return(
    <div className="card_public_group" onClick={()=>navigate(PUBLIC_GROUP_URI+"/detail/2")}>
    <div className="icon">
    ...
    <div className="card_public_group__body">
      {subTitle}
    </div>
